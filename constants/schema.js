...
window.LiveDataVersion.schema = {
  ...
  cache: {
    ...
    latestNavKey: "live-funalytics-latest-nav-cache-v5",
    navSchemeListKey: "live-funalytics-nav-scheme-list-v5",
    navMatchMapKey: "live-funalytics-nav-match-map-v5",
    navResolverKey: "live-funalytics-nav-resolver-cache-v5",
    navFallbackKey: "live-funalytics-nav-fallback-cache-v5",
    datasetKey: "fundpulse-live-data-v5",
    ttlMs: 10 * 60 * 1000,
