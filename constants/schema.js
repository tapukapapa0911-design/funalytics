...
window.LiveDataVersion.schema = {
  ...
  cache: {
    ...
    latestNavKey: "live-funalytics-latest-nav-cache-v4",
    navSchemeListKey: "live-funalytics-nav-scheme-list-v4",
    navMatchMapKey: "live-funalytics-nav-match-map-v4",
    navResolverKey: "live-funalytics-nav-resolver-cache-v4",
    navFallbackKey: "live-funalytics-nav-fallback-cache-v4",
    datasetKey: "fundpulse-live-data-v4",
    ttlMs: 10 * 60 * 1000,
